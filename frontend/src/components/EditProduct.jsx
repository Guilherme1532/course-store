...
const EditProduct = ({ data: editProductData, fetchData, close }) => {
  ...
  return (
    <section className="fixed inset-0 bottom-0 right-0 left-0 bg-[#000000cc] z-50 flex justify-center items-center p-2 text-black">
      <div className="bg-white rounded p-4 w-full max-w-[1024px] flex flex-col gap-2 overflow-y-auto max-h-[80vh]">
        ...
        <div className="grid p-3">
          <form onSubmit={handleSubmit} className="grid gap-4">
            ...
            <div
              ...
              className="hover:bg-primary-200 bg-white py-1 px-3 w-32 text-center font-semibold border border-primary-200 rounded-md cursor-pointer"
            >
