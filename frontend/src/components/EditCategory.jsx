...
const EditCategory = ({data: CategoryData, close, fetchData}) => {
  ...
  return (
   <section className="fixed inset-0 bottom-0 right-0 left-0 bg-[#0000004c] z-50 flex justify-center items-center p-2 text-black">
      <div className="bg-white max-w-[1024px] w-full rounded-lg shadow-lg p-6 text-center">
        ...
        <form onSubmit={handleSubmit} className="my-3 grid gap-2">
                  ...
                  className={`
                    ${
                      !data.name
                        ...
                        : "text-sm font-bold text-orange-600 min-w-20 border border-gray-600 bg-gray-800 hover:bg-gray-700 flex items-center justify-center cursor-pointer"
                    }
          ...
          <button className="flex justify-center">
            {loading ? (
              ...
              <div className="text-sm font-bold text-orange-600 min-w-20 border border-gray-600 bg-gray-800 hover:bg-gray-700 flex items-center justify-center cursor-pointer px-3 py-1 rounded-full">
                Editar Categoria
              </div>
            )}
          </button>
